"""A2A wiring for the orchestrator: Agent, Executor (Pattern B), RequestHandler."""
...
from orchestrator.graph import AGENT_NAME, build_graph
...
class OrchestratorAgent:
    ...
    async def invoke(self) -> dict:
        result = self._graph.invoke({"name": AGENT_NAME})
        return result["name"]
